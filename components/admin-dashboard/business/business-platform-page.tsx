...
import { BusinessWorkflowsManager } from "./business-workflows-manager"

export async function BusinessPlatformPage() {
  const [plans, accounts, addOnRequests, supportTickets] = await Promise.all([
    listBusinessPlans(),
    listBusinessAccounts(),
    listAdminBusinessAddOnRequests(),
    listAdminBusinessSupportTickets(),
  ...
  return (
    <div className="space-y-8">
      ...
      <BusinessWorkflowsManager addOnRequests={addOnRequests} supportTickets={supportTickets} />
    </div>
  )
}
