...
export function RfqsLivePage({ initialRfqs }: { initialRfqs: AdminRfq[] }) {
  ...
  return <div className="space-y-8">
    ...
    <Input value={search} maxLength={120} onChange={(event) => setSearch(event.target.value.slice(0, 120))} placeholder="Search by RFQ ID, project, company, or contact..." className="max-w-xl border-[#2A2A2A] bg-[#1A1A1A] text-white placeholder:text-[#9CA3AF]" />
